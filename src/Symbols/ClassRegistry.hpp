...
class ClassRegistry {
  public:
     ...
     */
    Modules::BaseModule *  getMethodModule(const std::string & className, const std::string & methodName) const;
    ...
    // Register a new method for a class and add to the Module manager too
    void addMethod(const std::string & className, const std::string & methodName,

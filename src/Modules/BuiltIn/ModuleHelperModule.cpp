...
Symbols::Value::ObjectMap ModuleHelperModule::buildModuleInfoMap(BaseModule * module, const std::string & path,
    ...
    infoMap["name"]          = Symbols::Value(utils::get_filename_stem(path));
...
void ModuleHelperModule::registerModule() {
    ...
    REGISTER_FUNCTION(
        "module_print_info", Symbols::Variables::Type::NULL_TYPE, params,
                            ...
                            for (const auto & [_, methodInfo] : methodsMap) {
                                ...
                                if (!docMap.empty()) {
                                    ...
                                    if (docMap.contains("parameters")) {
                                        auto paramsMap =
                                            std::get<Symbols::Value::ObjectMap>(docMap["parameters"].get());
